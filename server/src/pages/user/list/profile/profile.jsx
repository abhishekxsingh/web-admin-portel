...
const UserProfile = () => {
	...
	//   const response = useSelector(({ profile }) => {
	//     return profile;
	//   });
	//   const { name, mobileNumber, userName, email } = response;

	const { data: userProfile,
		pagination: { totalRecords },
		isFetching, } = useSelector((state) => {
			return state.list;
		});
	const { name, mobileNumber, email } = userProfile

	const userProfileData = userProfile.map((element) => {
	})
			...
			<div className="profile">
				<div className="profile-header">
					...
					<ul className="profile-header-tab nav nav-tabs">
						...
						{/* <li className="nav-item"><a href="#profile-post" className="nav-link active" data-bs-toggle="tab">LOANS</a></li>
						<li className="nav-item"><a href="#profile-photos" className="nav-link" data-bs-toggle="tab">WORK INFO</a></li>
						<li className="nav-item"><a href="#profile-videos" className="nav-link" data-bs-toggle="tab">DOCUMENTS</a></li> */}
					</ul>
				</div>
			</div>
							...
							<table className="table table-profile align-middle">
								...
								<tbody>
									<tr>
										...
										<td>
											<i className="fa fa-mobile fa-lg me-5px"></i>{" "}
											{mobileNumber || "N/A"}
									...
									<tr>
										...
										<td>
											<i class="fa-solid fa-envelope"></i> {email || "N/A"}
											{/* <a href="#/" className="text-decoration-none fw-bold">
                        <i className="fa fa-plus fa-fw"></i> Add Number
                      </a> */}
										</td>
									</tr>
									{/* <tr>

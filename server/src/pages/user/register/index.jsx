    ...
    <div className="register register-with-news-feed">
      <div className="news-feed">
        ...
        <div className="news-caption">
          ...
          <p>
            As a unbiasly Admin administrator, you use the Color Admin console to
          ...
          <form onSubmit={handleSubmit} className="fs-13px">
            ...
            <div className="form-check mb-4">
              ...
              <label className="form-check-label" htmlFor="agreementCheckbox">
                ...
                <Link to="/user/register-v3">Terms</Link> and that you have read
                our <Link to="/user/register-v3">Data Policy</Link>, including
                our <Link to="/user/register-v3">Cookie Use</Link>.
              </label>
            </div>
            <div className="mb-4">
              <button
